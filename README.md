...
### ETL Process
  - Extract – Imported raw data from source files (CSV/Excel)
  - Transform – Cleaned data (handled nulls, removed duplicates, formatted fields)
  - Load – Loaded transformed data into structured warehouse tables

### Future Improvements
  - Integration with Tableau / Power BI dashboards
